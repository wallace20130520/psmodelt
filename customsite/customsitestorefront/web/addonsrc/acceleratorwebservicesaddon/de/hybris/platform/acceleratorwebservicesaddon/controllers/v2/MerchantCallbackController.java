...
public class MerchantCallbackController
{
	...
	@ApiOperation(value = "Verify the decision of the Merchant", notes = "Verify the decision of the Merchant. \n\nNote, "
	...
	@ResponseStatus(value = HttpStatus.OK)
	@ApiOperation(value = "Verify the decision of the Merchant for a cart", notes = "Verify the decision of the Merchant for a specific cart. Will store "
			+ "information of the PaymentSubscriptionResult for the cart. \n\nNote, the “Try it out” button is not enabled for this method (always returns "
			+ "an error) because the Merchant Callback Controller handles parameters differently, depending on which payment provider is used. For more "
			+ "information about this controller, please refer to the “acceleratorwebservicesaddon AddOn” documentation on help.hybris.com.")
	@ApiBaseSiteIdParam
	public void handleMerchantCallback(@ApiIgnore final HttpServletRequest request,
