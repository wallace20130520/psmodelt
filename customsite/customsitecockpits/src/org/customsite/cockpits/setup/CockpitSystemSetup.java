 ...
 */
package org.customsite.cockpits.setup;
...
import org.customsite.cockpits.constants.CustomsiteCockpitsConstants;
 ...
 */
@SystemSetup(extension = CustomsiteCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(CustomsiteCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(CustomsiteCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						CustomsiteCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/customsitecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
